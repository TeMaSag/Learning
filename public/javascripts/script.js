    ...
    $.ajax({
      ...
      success: function (data) {        
        ...
        if (dataParse.result[0].username == null) {
          ...
          $("#showUrls").html(`'<table class="table table-dark table-bordered">
                                  <thead>
                                    <tr>
                                      <th>#</th>
                                      <th>ORIGIN URL</th>
          ...
          for (let i = 0; i < dataParse.result.length; i++) {
            $(".asds").append(`'<tr> 
                                  <th scope="row">' + i + '</th>
                                    <td height=50><a href="' + dataParse.result[i].url + '" target="_blank">' + dataParse.result[i].url + '</td>
                                    <td height=50><a href="' + window.location.origin + '/hash/' + dataParse.result[i].urlShorten + '" target="_blank">' + window.location.origin + '/' + dataParse.result[i].urlShorten + '</td>
                                    <td height=50>' + dataParse.result[i].date + '</td><td height=50>' + dataParse.result[i].count + '</td>
                                  </tr>'`)
          }
          $('#showUrls').show();
